...
import org.openmrs.module.patientlist.api.web.ModuleWebConstants;
...
public class PatientListLandingPageController {
	...
	public void get(PageModel model, @SpringBean("appFrameworkService") AppFrameworkService appFrameworkService,
		...
		List<Extension> extensions =
		        appFrameworkService
		                .getExtensionsForCurrentUser(ModuleWebConstants.PATIENT_LIST_LANDING_PAGE_EXTENSION_POINT_ID);
